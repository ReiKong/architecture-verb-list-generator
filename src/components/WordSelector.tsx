    ...
    return (
        <div className="">
            <Combobox value={selectedVerb} onChange={handleChange} onClose={() => setQuery('')}>
                <ComboboxInput
                    className="text-5xl sm:text-6xl md:text-7xl w-[294px] sm:w-[374px] md:w-[444px] text-zinc-500 h-[50px] sm:h-20 hover:text-zinc-300 focus:text-zinc-300 font-bold tracking-tighter bg-transparent border-b-4 border-b-zinc-500 hover:border-b-zinc-300 focus:border-b-zinc-300 focus:outline-none"
                    aria-label="Assignee"
