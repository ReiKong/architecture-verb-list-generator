    ...
    return (
        <div className="relative w-fit">
            <Combobox value={selectedVerb} onChange={handleChange} onClose={() => setQuery('')}>
                ...
                />
                <ComboboxOptions
                    className="absolute left-0 z-10 mt-2 w-[294px] sm:w-[374px] md:w-[444px] bg-zinc-800 border border-zinc-700 empty:invisible tracking-tight max-h-96 overflow-auto"
                >
